...
namespace MythicEmpire.UI.Lobby
{
    public class InventoryUI : MonoBehaviour
    {
        ...
        public void FilterTowerCard(Toggle toggle)
        {
            ...
            _listCardRendered.ForEach(card =>
                card.gameObject.SetActive(card.CardData.TypeOfCard == CardType.TowerCard));
        }
        ...
        public void FilterMonsterCard(Toggle toggle)
        {
            if (!toggle.isOn) return;
            _listCardRendered.ForEach(card =>
                card.gameObject.SetActive(card.CardData.TypeOfCard == CardType.MonsterCard));
        }
        ...
        public void FilterSpellCard(Toggle toggle)
        {
            if (!toggle.isOn) return;
            _listCardRendered.ForEach(card =>
                card.gameObject.SetActive(card.CardData.TypeOfCard == CardType.SpellCard));
        }
