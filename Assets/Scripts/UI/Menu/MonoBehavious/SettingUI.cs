...
{    
    ...
    public class SettingUI : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _settingDataModel = _settingLocalData.GetSettingData();
            ...
            Screen.fullScreen = _settingDataModel.IsFullScreen;
        ...
        private void OnMusicSoundChange(float value)
        {
            ...
            _settingLocalData.UpdateSettingModel(_settingDataModel);
        }
